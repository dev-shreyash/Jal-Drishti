...
<<<<<<<< HEAD:server/prisma/migrations/20251231112733_init_final_schema_with_change_request/migration.sql
    `algorithm` VARCHAR(191) NOT NULL DEFAULT 'Holt-Winters',
...
========
    ...
    `model_weights` JSON NOT NULL,
    `village_id` INTEGER NOT NULL,
>>>>>>>> 22eaf92976e6c4e3d47d7e38ff359ed22ca23e73:server/prisma/migrations/20260204055346_init/migration.sql
...
-- AddForeignKey
<<<<<<<< HEAD:server/prisma/migrations/20251231112733_init_final_schema_with_change_request/migration.sql
ALTER TABLE `AiModel` ADD CONSTRAINT `AiModel_pump_id_fkey` FOREIGN KEY (`pump_id`) REFERENCES `Pump`(`pump_id`) ON DELETE RESTRICT ON UPDATE CASCADE;
========
